/***************************************************************************//**
 * @file efr32_ble_velocity_6pwm.ino
 * @brief Silabs MG24 6PWM closed loop velocity control example with HALL sensor based rotor position and Bluetooth LE serial
 *******************************************************************************
 * # License
